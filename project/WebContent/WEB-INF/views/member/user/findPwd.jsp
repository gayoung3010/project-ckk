...
<style>
/* 
주: Ajax를 사용하지 않고 페이지를 전환하는 방식으로 비밀번호 찾기 작업을 수행하기 때문에, 페이지 주소가 바뀌게 됨.
이에 따라 index 화면이 날아가므로 별도로 재사용해 줌.
즉, 아래의 코드는 index에 해당하는 화면을 위한 css 코드이다. */
    @font-face {
...
<div class="lostpw-wrapper">
	<div class="mypage-lostpw" id="mypage-lostpw">
                ...
                <form class="user-lostpw" id="user-lostpw" action="<%=request.getContextPath()%>/user/checkInfo" method="post">
